...
export default function Home({ yourLocalBalance, readContracts }) {
  ...
  const items = [
    {
      ...
      description: (
        <>
          ...
          <code className="text-xs rounded-sm bg-blue-100 text-blue-500 p-1">
    ...
    purpose
      ? {
          ...
          description: (
            <>
              ...
              <code className="text-xs rounded-sm bg-blue-100 text-blue-500 p-1">{purpose}</code>
            </>
          ),
      ...
      : {
          ...
          description: (
            <>
              Run <code className="text-xs rounded-sm bg-blue-100 text-blue-500 p-1">yarn chain</code> and{' '}
              <code className="text-xs rounded-sm bg-blue-100 text-blue-500 p-1">yarn deploy</code> to deploy your first
              contract
            </>
          ),
          icon: LightningBoltIcon,
        ...
        },
    {
      ...
      description: (
        <>
          An example prop of your balance is passed into the Home view:{' '}
          <code className="text-xs rounded-sm bg-blue-100 text-blue-500 p-1">
  ...
  return (
    <div>
      ...
      <ul
        role="list"
        className="mt-6 border-t border-b border-gray-200 dark:border-gray-700 py-6 grid grid-cols-1 gap-6 sm:grid-cols-2"
      >
          ...
          <li key={itemIdx} className="flow-root">
            <div
              className={classNames(
                item.href
                  ? 'hover:bg-gray-50 dark:hover:bg-gray-700 focus-within:ring-2 focus-within:ring-indigo-500'
                  : '',
      ...
      <div className="mt-4 flex">
        <a
          ...
          target="_blank"
          className="text-sm font-medium text-indigo-600 dark:text-indigo-500 hover:text-indigo-500"
        >
